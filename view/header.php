...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <a class="navbar-brand" href="#" style="font-size: 1.5em;">Marka</a>
    </div>
	...
	<!-- <a class="navbar-brand" href="#">Marka</a> -->
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      ...
		      <ul class="nav navbar-nav navbar-right" style="margin-top: 8px; padding-right: 25px; padding-left: 25px">
		        <li><button type="button" class="btn btn-link">Login</button></li>
		        <li style="margin-left: 10px;"><button type="button" class="btn btn-info">Sign Up</button></li>
		      </ul><br>
